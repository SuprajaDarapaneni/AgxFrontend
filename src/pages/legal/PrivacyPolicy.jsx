    ...
    <main className="bg-white text-gray-800 font-sans pt-20 pb-32 px-6 lg:px-0">
      ...
      <div className="max-w-5xl mx-auto">
        <div className="mb-12 text-center">
          ...
          <p className="text-sm text-gray-500">Effective Date: June 5, 2025</p>
        </div>
        ...
        <div className="space-y-10">
          ...
          <section>
            ...
            <ul className="mt-2 ml-6 list-none space-y-1">
              <li>📧 <a href="mailto:privacy@agx-international.com" className="text-pink-700 underline">privacy@agx-international.com</a></li>
