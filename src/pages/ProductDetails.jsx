...
const ProductDetails = () => {
    ...
    return (
      <div className="flex items-center justify-center min-h-screen bg-gray-100">
        <div className="text-center bg-white p-6 rounded-xl shadow-md">
          ...
          <p className="text-gray-600 my-4">It seems this product does not exist.</p>
  ...
  return (
    <>
      ...
      {zoomedImage && (
        <div
          className="fixed inset-0 z-50 bg-black bg-opacity-80 flex items-center justify-center p-10"
      ...
      {/* Hero Banner */}
      {/* <div className="relative bg-gradient-to-r from-indigo-50 to-pink-50 p-10 rounded-b-3xl shadow-inner mb-10">
        <div className="relative z-10">
          <span className="text-indigo-600 uppercase text-sm font-bold tracking-wider">
            {product.category}
          </span>
          <h1 className="text-3xl sm:text-5xl font-extrabold text-gray-900 mt-2">
            {product.name}
          </h1>
          <p className="mt-4 text-lg text-gray-700 max-w-3xl">
            Discover excellence with our {product.name}. Built for the modern {product.category} environment.
          </p>
        </div>
      </div> */}
      ...
      >
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
                ...
                {product.multipleImages.map((img, idx) => (
                  <img
                    ...
                    className={`cursor-pointer rounded-lg border ${
                      mainImage === `https://agxbackend.onrender.com${img}`
                        ? "border-indigo-500 ring-2"
                        : "border-gray-200"
                    }`}
                    onClick={() =>
                      setMainImage(`https://agxbackend.onrender.com${img}`)
                    }
                  />
                ))}
              </div>
          ...
          <div className="space-y-10">
            <section id="introduction" className="bg-white p-6 rounded-xl shadow-inner border">
            ...
            {product.description && (
              <section id="features" className="bg-indigo-50 p-6 rounded-xl shadow-inner border border-indigo-200">
            ...
            {product.whyChooseUsContent && (
              <section id="why-us" className="bg-pink-50 p-6 rounded-xl shadow-inner border border-pink-200">
            ...
            {product.interiorContent && (
              <section id="interior" className="bg-gray-50 p-6 rounded-xl shadow-inner border">
                <h2 className="text-xl font-semibold mb-4">Interior Details</h2>
            ...
            <motion.div
              ...
              className="bg-gradient-to-r from-indigo-100 to-pink-100 p-6 rounded-xl border border-indigo-200 shadow-md"
            >
              ...
              <div className="flex flex-wrap gap-4 mt-4">
                ...
                <Link
                  to="/products"
                  className="px-6 py-3 border border-indigo-600 text-indigo-600 rounded-full hover:bg-indigo-100"
                >
                  Back to Products
                </Link>
              </div>
