  ...
  return (
    <>
      ...
      <header className="bg-white shadow-md fixed w-full top-0 left-0 z-50">
        {/* Top Bar */}
        <div className="bg-pink-100 py-2 px-6 border-b border-pink-200 hidden md:block">
          <div className="max-w-screen-xl mx-auto flex justify-end items-center space-x-6 text-sm">
            <div className="flex items-center gap-2">
              ...
              <a href="mailto:info@agx-international.com" className="hover:underline text-gray-700">
                info@agx-international.com
              </a>
            </div>
            <div className="flex items-center gap-2">
              <Phone size={16} className="text-pink-700" />
              <a href="tel:+16479049839" className="hover:underline text-gray-700">
                +1 647 904 9839
              </a>
            </div>
            <div className="flex items-center gap-2">
